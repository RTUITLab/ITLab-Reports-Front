    ...
    <page-content :loading="loadingInProcess">
      ...
      <b-tabs>
        ...
        <b-tab title="Написать">
          ...
          <p>Вы можете прикрепить изображения или документы. Формат описания поддерживает формат <a href="https://guides.github.com/pdfs/markdown-cheatsheet-online.pdf" target="_blank">Markdown</a>.</p>
